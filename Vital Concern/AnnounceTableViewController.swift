...
class AnnounceTableViewController: UITableViewController {
    ...
    @IBOutlet var announceTableView: UITableView!
    ...
    override func viewDidLoad() {
        ...
        func getdata(){
            let myUrl = URL(string: "https://www.vitalconcern.com/ios/announcements/index.php")
   ...
   override func numberOfSections(in tableView: UITableView) -> Int
    {
        ...
        else
        {
            ...
            noDataLabel.text          = "No current announcements"
...
return self.arrdata.count
    ...
    override func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell {
        ...
        let cell:AnnounceTableViewCell = announceTableView.dequeueReusableCell(withIdentifier: "cell") as! AnnounceTableViewCell
