//
//  HelpReqsTableViewController.swift
//  Vital Concern
//
...
class HelpReqsTableViewController: UITableViewController {
    ...
    @IBOutlet var helpreqsTableView: UITableView!
    ...
    override func viewDidLoad() {
        ...
        self.navigationItem.title = "Help Requests"
        
        
        func getdata(){
            let myUrl = URL(string: "https://www.vitalconcern.com/ios/helprequests/index.php")
                    ...
                    if error == nil{
                        ...
                        for mainarr in self.arrdata{
                            ...
                            DispatchQueue.main.async {
                                self.helpreqsTableView.reloadData()
                            }
...
*/
    ...
    override func numberOfSections(in tableView: UITableView) -> Int
    {
        ...
        else
        {
            ...
            noDataLabel.text          = "No current help requests"
 ...
 return self.arrdata.count
    ...
    override func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell {
        ...
        let cell:HelpReqsTableViewCell = helpreqsTableView.dequeueReusableCell(withIdentifier: "cell") as! HelpReqsTableViewCell
